              ...
              <div className="card">
                ...
                <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
                  <div className="rounded-md bg-neutral-800/70 p-2">
                    <p className="flex justify-between text-neutral-100">{inn.striker.name} * <span>{inn.striker.runs} ({inn.striker.balls})</span></p>
                  ...
                  <div className="rounded-md bg-neutral-800/70 p-2">
                    <p className="flex justify-between text-neutral-100">{inn.currentBowler.name} <span>{inn.currentBowler.wickets}/{inn.currentBowler.runs} ({oversLabel(inn.currentBowler.legalBalls)})</span></p>
                  </div>
                </div>
