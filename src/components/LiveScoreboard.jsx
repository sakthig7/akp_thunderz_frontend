...
const BallPill = ({ label }) => {
  const color =
    ...
    label.includes('wd') || label.includes('nb') ? 'bg-yellow-500 text-neutral-100' :
        ...
        <div className="p-4">
          ...
          <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
            <div className="rounded-md bg-neutral-800/70 p-3">
              ...
              <p className="flex justify-between text-neutral-100">
                  ...
                  <tbody>
                    {innData.battingCard.map((b, i) => (
                      <tr key={i} className="border-t border-neutral-800 text-neutral-300">
                        ...
                        <td className="py-1 pr-2 font-semibold text-neutral-100">{b.runs}</td>
                  ...
                  <tbody>
                    {innData.bowlingCard.map((b, i) => (
                      <tr key={i} className="border-t border-neutral-800 text-neutral-300">
                        ...
                        <td className="py-1 pr-2 font-semibold text-neutral-100">{b.wickets}</td>
